...
function qchero_pro_notice(){
    ...
    ?>
    <div id="message-hero" class="notice notice-info is-dismissible" style="padding:4px 0px 0px 4px;background:#000;">
        <?php
            printf(
                __('%s  %s  %s', 'qchero'),
                '<a href="'.esc_url('https://www.quantumcloud.com/products/slider-hero/').'" target="_blank">',
                '<img src="'.esc_url(QCLD_SLIDERHERO_IMAGES).'/slider-hero.jpg" >',
                '</a>'
            );
